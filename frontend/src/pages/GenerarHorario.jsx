    ...
    const handleGenerar = async (e) => {
        ...
        try {
            ...
            const params = new URLSearchParams({
                grupos_generar: formData.grupos_generar,
                turno: formData.turno,
                nombre_carrera: formData.nombre_carrera,
                cuatrimestre: formData.cuatrimestre
            })

            const response = await fetch(`${API_URL}/api/generar-horario?${params}`, {
                method: 'POST'
            })
        ...
        <div className="generar-horario-page">
            <div className="generar-container">
                ...
                <div className="form-card">
                    <form onSubmit={handleGenerar}>
                        <div className="form-group">
                            ...
                            <small className="field-hint">Mantén presionado Ctrl (o Cmd en Mac) para seleccionar múltiples docentes</small>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                disabled={loading}
                            />
                            <small className="field-hint">Se generarán grupos como: {formData.nombre_carrera || 'CARRERA'} {formData.cuatrimestre || 'X'}-1, {formData.nombre_carrera || 'CARRERA'} {formData.cuatrimestre || 'X'}-2...</small>
                        </div>

                        <button type="submit" className="btn-crear-horario" disabled={loading}>
                ...
                <div className="info-section">
                    ...
                    <p>El sistema generará automáticamente los horarios aplicando las siguientes restricciones:</p>
                    <ul>
